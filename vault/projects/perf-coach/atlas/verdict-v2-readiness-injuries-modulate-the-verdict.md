...
Verdict v2 — readiness & injuries modulate the verdict — no entry point could be discovered.
...
<!-- OPEN QUESTION: No entry point could be discovered for `Verdict v2 — readiness & injuries modulate the verdict` — cannot begin tracing -->
