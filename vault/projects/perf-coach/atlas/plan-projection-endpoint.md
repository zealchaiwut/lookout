...
Plan projection endpoint — no entry point could be discovered.
...
<!-- OPEN QUESTION: No entry point could be discovered for `Plan projection endpoint` — cannot begin tracing -->
