...
Performance curve — traced from `tests/test_performance_curve_pure_function__606.py` through 5 source file(s).

## Entry Points

- `tests/test_performance_curve_pure_function__606.py` (tracing origin)
...
<!-- OPEN QUESTION: `pytest` imported in `test_performance_curve_pure_function__606.py` but `pytest.py` not found in source — handler unresolved -->
