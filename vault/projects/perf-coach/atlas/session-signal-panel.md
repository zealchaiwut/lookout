...
Session signal panel — traced from `tests/test_session_signal_detail_panel__1052.py` through 3 source file(s).

## Entry Points

- `tests/test_session_signal_detail_panel__1052.py` (tracing origin)

## Related Issues

- #1673 — [follow-up] Session-wide glob.glob monkeypatch in conftest has no teardown
- #1010 — [follow-up] Implement new-target goal-vs-start-weight guard in _saveEditPanel (AC3 of #477)
...
<!-- OPEN QUESTION: `pytest` imported in `test_session_signal_detail_panel__1052.py` but `pytest.py` not found in source — handler unresolved -->
<!-- OPEN QUESTION: `httpx` imported in `test_session_signal_detail_panel__1052.py` but `httpx.py` not found in source — handler unresolved -->
<!-- OPEN QUESTION: `sqlalchemy` imported in `test_session_signal_detail_panel__1052.py` but `sqlalchemy.py` not found in source — handler unresolved -->
