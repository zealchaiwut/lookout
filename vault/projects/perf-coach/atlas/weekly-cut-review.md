...
Weekly cut review — traced from `tests/test_weekly_cut_review__1355.py` through 3 source file(s).

## Entry Points

- `tests/test_weekly_cut_review__1355.py` (tracing origin)

## Related Issues

- #1736 — Sprint 132 Executive Summary
- #1731 — Sprint 131.1 Executive Summary
- #1727 — Sprint 131 Executive Summary
- #1725 — [follow-up] get_weight_chart now returns weekly_rate×4 for delta_30d_kg — unrequested behavior change from #1713
- #1722 — Sprint 130.1 Executive Summary
- #1721 — Sprint 130 Executive Summary
...
- #1687 — Sprint 129 Executive Summary
...
<!-- OPEN QUESTION: `pytest` imported in `test_weekly_cut_review__1355.py` but `pytest.py` not found in source — handler unresolved -->
<!-- OPEN QUESTION: `httpx` imported in `test_weekly_cut_review__1355.py` but `httpx.py` not found in source — handler unresolved -->
