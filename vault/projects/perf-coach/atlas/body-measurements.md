...
Body measurements — traced from `tests/test_1358_body_measurements.py` through 3 source file(s).

## Entry Points

- `tests/test_1358_body_measurements.py` (tracing origin)
...
<!-- OPEN QUESTION: `httpx` imported in `test_1358_body_measurements.py` but `httpx.py` not found in source — handler unresolved -->
<!-- OPEN QUESTION: `pytest` imported in `test_1358_body_measurements.py` but `pytest.py` not found in source — handler unresolved -->
<!-- OPEN QUESTION: `sqlalchemy` imported in `test_1358_body_measurements.py` but `sqlalchemy.py` not found in source — handler unresolved -->
