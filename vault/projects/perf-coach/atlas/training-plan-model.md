...
Training plan model — no entry point could be discovered.
...
<!-- OPEN QUESTION: No entry point could be discovered for `Training plan model` — cannot begin tracing -->
