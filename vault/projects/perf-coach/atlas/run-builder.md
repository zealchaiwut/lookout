...
Run Builder — traced from `tests/test_run_view_run_builder__567.py` through 3 source file(s).

## Entry Points

- `tests/test_run_view_run_builder__567.py` (tracing origin)

## Related Issues

- #972 — [follow-up] Fix semantic mismatch in habit_insights._generate_line using praise_line_builder
...
<!-- OPEN QUESTION: `httpx` imported in `test_run_view_run_builder__567.py` but `httpx.py` not found in source — handler unresolved -->
<!-- OPEN QUESTION: `pytest` imported in `test_run_view_run_builder__567.py` but `pytest.py` not found in source — handler unresolved -->
<!-- OPEN QUESTION: `dotenv` imported in `test_run_view_run_builder__567.py` but `dotenv.py` not found in source — handler unresolved -->
<!-- OPEN QUESTION: `sqlalchemy` imported in `test_run_view_run_builder__567.py` but `sqlalchemy.py` not found in source — handler unresolved -->
