---
feature: Lean program — Phase 1, the daily floor
files_read:
  []
traced: 2026-08-13
stale: false
...
Lean program — Phase 1, the daily floor — no entry point could be discovered.
...
- #1724 — [follow-up] CONCURRENTLY index build can leave an INVALID index that the existence-guard then skips
...
<!-- OPEN QUESTION: No entry point could be discovered for `Lean program — Phase 1, the daily floor` — cannot begin tracing -->
